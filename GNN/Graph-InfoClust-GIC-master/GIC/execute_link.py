...
def get_roc_score(edges_pos, edges_neg, embeddings, adj_sparse):
    ...
    print(edges_pos.shape, edges_neg.shape, embeddings.shape, adj_sparse.shape)
    ...
    # print('predictions', type(preds_all), preds_all.shape)
...
for m in range(1):
    ...
    # with open('our_data/attributes.pkl', 'rb') as file:
    #     features = pickle.load(file)
    #
    # features = lil_matrix(features)
    #
    # with open('our_data/attributes_lil.pkl', 'wb') as file:
    ...
    with open('our_data/ground_truth.pkl', 'rb') as file:
